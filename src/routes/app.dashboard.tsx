        ...
        <div className="rounded-[16px] border border-border bg-card p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="flex h-7 w-7 items-center justify-center rounded-[8px] bg-[color:var(--success-soft)] text-[color:var(--success)]">
          ...
          <div className="mt-1 h-2 overflow-hidden rounded-full bg-secondary">
            <div
              className={cn("h-full bg-[color:var(--success)] transition-all duration-500")}
          ...
          <div className="mt-2 flex gap-1.5">
            <input
              ...
              placeholder="0"
              className="w-full min-w-0 rounded-[8px] bg-secondary px-2 py-1.5 text-xs outline-none focus:ring-2 focus:ring-[color:var(--success)]"
            />
            <button
              type="button"
              onClick={updateSteps}
              className="rounded-[8px] bg-[color:var(--success)] px-3 text-xs font-semibold text-white transition-opacity hover:opacity-90 active:scale-95"
            >
              {t("save")}
            </button>
          </div>

...
export const translations = {
  ka: {
    ...
    // Welcome / landing
    getStarted: "დავიწყოთ",
    welcomeHeadlineLeft: "თვალი ადევნე",
    welcomeHeadlineAccent: "ყოველ",
    welcomeHeadlineRight: "ლუკმას.",
    welcomeSubheadline: "პროდუქტების სკანირება, კალორიების თვალყური და მიზნების მიღწევა — ყველაფერი ერთ ადგილას.",
    featureScan: "AI სკანერი",
    featureCalories: "კალორიები",
    featureGoals: "მიზნები",
    // Smooth signup flow
    createAccount: "ანგარიშის შექმნა",
    letsGetYouIn: "მოდი დაგარეგისტრიროთ",
    whatsYourName: "რა გქვია?",
    whatsYourEmail: "შენი ელ-ფოსტა?",
    chooseAPassword: "აირჩიე პაროლი",
    namePlaceholder: "შენი სახელი",
    emailPlaceholder: "you@example.com",
    passwordHint: "მინიმუმ 6 სიმბოლო",
    welcomeFirstName: "გამარჯობა, {name}! 🎉",
    almostDone: "თითქმის მზად ხარ",
    finishSignup: "ანგარიშის შექმნა",
  },
  en: {
    appName: "Bitfit",
    ...
    welcomeHeadlineLeft: "Track",
    welcomeHeadlineAccent: "every",
    welcomeHeadlineRight: "bite.",
    welcomeSubheadline: "Scan food, track calories, hit your goals — all in one beautifully simple app.",
    featureScan: "AI scan",
    ...
    welcomeFirstName: "Welcome, {name}! 🎉",
    almostDone: "Almost done",
    finishSignup: "Create my account",
  },
} as const;
